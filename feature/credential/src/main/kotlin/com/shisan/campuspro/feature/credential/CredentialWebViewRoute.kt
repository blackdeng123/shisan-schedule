...
private const val CREDENTIAL_TARGET_URL = "https://kxdzpz.jsu.edu.cn"
...
fun CredentialWebViewRoute(
    ...
    Scaffold(
        ...
        when (val state = pageState) {
            ...
            is PortalPageState.Ready -> CredentialWebView(
                castgc = state.castgc,
                        ...
                        cookieManager.setCookie(
                            ...
                            scope.launch(Dispatchers.IO) {
                                ...
                                withContext(Dispatchers.Main) {
                                    if (!released.get()) loadUrl(CREDENTIAL_TARGET_URL)
                                }
                            }
                        }
                    }
